                        ...
                        <div class="d-flex flex-wrap  mb-4">
                            ...
                            <div class="col-md-6 col-sm-12 mobile-margin-for-button ">
                                <button class="btn btn-success  fs-sm-4" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">Create Book Country</button>
                                ...
                                <div class="modal-content">
                                    <form @submit.prevent="CategorySubmit">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5 " id="exampleModalLabel">Enter New Country Name
                                            </h1>
                        ...
                        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Country Name</h1>
...
const item = ref(page.props.list);
 ...
 const categoryUpdateSubmit = () => {
    if (categoryEdit.name == '') {
        ...
        categoryEdit.put('/user-country-update', {
            onSuccess: () => {
   ...
   const categoryDelete = useForm({
    ...
    const deleteConfirm = () => {
        categoryDelete.delete('/user-country-delete', {
            onSuccess: () => {
