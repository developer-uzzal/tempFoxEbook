                       ...
                       <div class="d-flex flex-wrap  mb-4">
                           ...
                           <div class="col-md-6 col-sm-12 mobile-margin-for-button ">
                               <button class="btn btn-success  fs-sm-4" data-bs-toggle="modal"
                                   data-bs-target="#exampleModal">Create Book Author</button>
                               ...
                               <div class="modal-content">
                                   <form @submit.prevent="AuthorSubmit">
                                       <div class="modal-header">
                                           <h1 class="modal-title fs-5 " id="exampleModalLabel">Enter New Book Author Name
                                           </h1>
                       ...
                       <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                           ...
                           <div class="modal-dialog modal-dialog-centered">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-header">
                                       <h1 class="modal-title fs-5" id="exampleModalLabel">Update Book Author Name</h1>
...
const AuthorSubmit = () => {
   ...
   if (form.name == '') {
       new Notify({
           status: 'error',
           title: 'Book Author name is required',
           autotimeout: 2000,
       })

   } else {

       form.post('/user-authors-create', {
           onSuccess: () => {
...
const categoryUpdateSubmit = () => {
   if (categoryEdit.name == '') {
       ...
       categoryEdit.put('/user-authors-update', {
           onSuccess: () => {
   ...
   // for delete book author
   const categoryDeleteClick = (id) => {
       categoryEdit.id = id;
   }

   const deleteConfirm = () => {
       categoryEdit.delete('/user-authors-delete', {
           onSuccess: () => {
