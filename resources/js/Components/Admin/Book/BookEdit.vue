...
const form = useForm({
    id : page.props.list.id,
    title: page.props.list.title,
    isbn: page.props.list.isbn,
    publish_year: page.props.list.publish_year,
    pageNumber: page.props.list.pageNumber,
    country_id: page.props.list.country_id,
    category_id: page.props.list.category_id,
    book_language_id: page.props.list.book_language_id,
    book_auth_id: page.props.list.book_auth_id,
    publication_id: page.props.list.publication_id,
    image: '',
    oldImage:page.props.list.image,
    previewImage: '',
